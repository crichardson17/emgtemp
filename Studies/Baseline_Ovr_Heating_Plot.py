...
import csv
Overview_File = '/Users/Sam/Documents/emgtemp/Studies/Baseline_Sim.ovr'
Overview_Data = np.genfromtxt(Overview_File, skip_header = 0, delimiter = '\t',dtype=float,names=True)
Heating_File = '/Users/Sam/Documents/emgtemp/Studies/Baseline_Sim.het'
...
heating_file = open('/Users/Sam/Documents/emgtemp/Studies/Baseline_Sim.het')
...
sp2 = plt.subplot(312)
line2, = plt.plot(depth,O3_Ratio, c = 'k', label = "OIII")
line3, = plt.plot(depth,O2_Ratio, linestyle = '--', c = 'k', label = "OII")
line4, = plt.plot(depth,O4_Ratio, linestyle = '-.', linewidth = 1.5, c = 'k', label = "OIV")
line5, = plt.plot(depth,O1_Ratio, linestyle = ':', linewidth = 2, c = 'k', label = "OI")
line6, = plt.plot(depth,H1_Ratio, c = 'r', label = "HI")
line7, = plt.plot(depth,H2_Ratio, linestyle = "--", c = 'r', label = "HII")
plt.xlabel("Depth")
plt.ylabel("O Frac")
plt.title("O Frac vs. Depth")
plt.legend(handles = [line2, line3, line4, line5, line6, line7], loc = 1)
...
#plt.plot()
plt.show()
plt.savefig("Baseline_Grains_Heating_Study_Plots.pdf")
