...
#plt.legend([plt.scatter(NII_Ha[i],OIII_Hb[i],color=Low_Temp_Color, s = markersize, marker = shape), plt.scatter(NII_Ha[i],OIII_Hb[i],color=Mid_Temp_Color, s = markersize, marker = shape), plt.scatter(NII_Ha[i],OIII_Hb[i],color=High_Temp_Color, s = markersize, marker = shape),plt.scatter(Cloudy_NII_Ha,Cloudy_OIII_Hb,c=Cloudy_Sim_Color, s = markersize, edgecolor = 'none')], (r"$\frac{OIII[5007]}{OIII[4363]}$<50.0",r"$50.0<\frac{OIII[5007]}{OIII[4363]}<100.0$",r"$\frac{OIII[5007]}{OIII[4363]}$>100.0","Cloudy Simulation"),scatterpoints = 1, loc = 'lower left',fontsize =8)
