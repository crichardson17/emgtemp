...
sp1.set_color_cycle(hden_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_OIII_Hb_transpose)
...
sm._A = []
smaxes = inset_axes(sp1, width=0.06, height=0.4, loc=3, bbox_to_anchor=(0.135, .56), bbox_transform=sp1.figure.transFigure)
cbar = plt.colorbar(sm,cax=smaxes)
cbar.ax.set_title('n$_H$',fontsize=8)
cbar.set_ticks([1,4])
cbar.set_ticklabels([1.0,4.0])
...
sm._A = []
smaxes = inset_axes(sp2, width=0.06, height=0.4, loc=3, bbox_to_anchor=(1.22, 4.56), bbox_transform=sp2.figure.transFigure)
cbar = plt.colorbar(sm,cax=smaxes)
...
sp3.set_color_cycle(hden_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_S_Ratio_transpose)
plt.xticks(np.arange(min(x), max(x)+1,1.0))
...
sp4.set_color_cycle(hden_colors)
...
sp5.set_color_cycle(hden_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_OI_Ratio_transpose)  
plt.legend([plt.scatter([],[],color='.75', s = markersize, marker = 'x', edgecolor = 'none'),plt.scatter([],[],color='0.75', s = markersize, marker = '+', edgecolor = 'none'), plt.scatter([],[],color='.75', s = markersize, marker = 'D', edgecolor = 'none'), plt.scatter([],[],color='.75', s = markersize, marker = 's', edgecolor = 'none'), plt.scatter([],[],color='.75', s = markersize, marker = '*', edgecolor = 'none')], ("Star-Forming","Composite","AGN","LINER","Ambiguous"),scatterpoints = 1, loc = 'lower left',fontsize =8)
...
sp6.set_color_cycle(hden_colors)
plt.plot(Cloudy_OI_Ratio_transpose,Cloudy_OIII_Hb_transpose)
...
sp7.set_color_cycle(hden_colors)
plt.plot(Cloudy_OI_Ratio_transpose,Cloudy_O_Ratio_transpose)
...
sp8.set_color_cycle(hden_colors)
