...
Cloudy_NII_Ha_array = np.reshape(Cloudy_NII_Ha,(5,-1))
Cloudy_OI_Ratio_array = np.reshape(Cloudy_OI_Ratio,(5,-1))
Cloudy_OIII_Hb_array = np.reshape(Cloudy_OIII_Hb,(5,-1))
Cloudy_Temp_Ratio_array = np.reshape(Cloudy_Temp_Ratio,(5,-1))
Cloudy_S_Ratio_array = np.reshape(Cloudy_S_Ratio,(5,-1))
Cloudy_NO_Ratio_array = np.reshape(Cloudy_NO_Ratio,(5,-1))
Cloudy_O_Ratio_array = np.reshape(Cloudy_O_Ratio,(5,-1))
Cloudy_S_Ha_Ratio_array = np.reshape(Cloudy_S_Ha_Ratio,(5,-1))
...
metal_colors = [plt.cm.Blues(i) for i in np.linspace(0.25,1,5)]
