...
Cloudy_File = '/Users/compastro/jenkins/emgtemp/Metals_Sims/z_1.5_hden_2.4_U_-0.5_-3.5/z_1.5_hden_2.4.csv'
...
Grid_File = '/Users/compastro/jenkins/emgtemp/Metals_Sims/z_1.5_hden_2.4_U_-0.5_-3.5/z_1.5_hden_2.4_grid.csv'
...
metal_colors = [plt.cm.winter(i) for i in np.linspace(0.25,1,1)]
