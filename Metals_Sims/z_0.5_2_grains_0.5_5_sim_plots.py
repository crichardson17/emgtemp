...
plt.plot(Cloudy_NII_Ha_array,Cloudy_OIII_Hb_array, lw = '1.5')
sp1.set_color_cycle(z_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_OIII_Hb_transpose, linestyle = '--')
...
#plt.legend([plt.scatter([],[],color='.75', s = markersize, marker = 'x', edgecolor = 'none'),plt.scatter([],[],color='0.75', s = markersize, marker = '+', edgecolor = 'none'), plt.scatter([],[],color='.75', s = markersize, marker = 'D', edgecolor = 'none'), plt.scatter([],[],color='.75', s = markersize, marker = 's', edgecolor = 'none'), plt.scatter([],[],color='.75', s = markersize, marker = '*', edgecolor = 'none')], ("SF","Comp","AGN","LINER","Amb"),scatterpoints = 1, loc = 'lower left',fontsize =8)
...
plt.plot(Cloudy_NII_Ha_array,Cloudy_Temp_Ratio_array, lw = '1.5')
sp2.set_color_cycle(z_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_Temp_Ratio_transpose, linestyle = '--')
plt.xticks(np.arange(min(x), max(x)+1,1.0))
...
sm._A = []
smaxes = inset_axes(sp2, width=0.06, height=0.4, loc=3, bbox_to_anchor=(.4, .1), bbox_transform=sp2.figure.transFigure)
cbar = plt.colorbar(sm,cax=smaxes)
...
plt.plot(Cloudy_NII_Ha_array,Cloudy_S_Ratio_array, lw = '1.5')
sp3.set_color_cycle(z_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_S_Ratio_transpose, linestyle = '--')
plt.xticks(np.arange(min(x), max(x)+1,1.0))
...
plt.plot(Cloudy_NII_Ha_array,Cloudy_NO_Ratio_array, lw = '1.5')
sp4.set_color_cycle(z_colors)
plt.plot(Cloudy_NII_Ha_transpose,Cloudy_NO_Ratio_transpose, linestyle = '--')
plt.xticks(np.arange(min(x), max(x)+1,1.0))
#plt.legend([plt.scatter([],[],color=Low_Temp_Color, s = markersize), plt.scatter([],[],color=Mid_Temp_Color, s = markersize), plt.scatter([],[],color=High_Temp_Color, s = markersize),plt.scatter([],[],c=Cloudy_Sim_Color, s = markersize, edgecolor = 'none')], (r"$\frac{OIII[5007]}{OIII[4363]}$<50.0",r"$50.0<\frac{OIII[5007]}{OIII[4363]}<100.0$",r"$\frac{OIII[5007]}{OIII[4363]}$>100.0","Cloudy Simulation"),scatterpoints = 1, loc = 'lower left',fontsize =8)
plt.show()
#plt.suptitle('hden = 2.4, U = -1.5, 0.5 < Z < 2.0, 0.5 < grains < 5.0')
plt.savefig("z_0.5_2_grains_0.5_5_plots.pdf", dpi = 600)
